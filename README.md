...
> [References](#8-references)) for binding information. Figures, dates and eligibility rules
...
>
> Created by **[Javier Nieto Centeno](https://www.linkedin.com/in/jnieto1970/)**

---

## Contents

1. [What is Pontes?](#1-what-is-pontes)
2. [Who is Pontes for?](#2-who-is-pontes-for)
3. [The two settlement models — which to use](#3-the-two-settlement-models--which-to-use)
4. [How cross-ledger DvP/PvP works (the Hash-Link protocol)](#4-how-cross-ledger-dvppvp-works-the-hash-link-protocol)
5. [How the Pontes network is used (functional view)](#5-how-the-pontes-network-is-used-functional-view)
...
## 7. Conclusions — strengths and weaknesses
